return {
  ...
  -- Trouble
  {
    ...
    keys = {
      ...
      { "<leader>xd", function() require("trouble").toggle("diagnostics", { filter = { buf = 0 } }) end, desc = "Document Diagnostics (Trouble)" },
      { "<leader>xw", function() require("trouble").toggle("diagnostics") end,                      desc = "Workspace Diagnostics (Trouble)" },
      { "<leader>xX", function() require("trouble").toggle("diagnostics", { filter = { buf = 0 } }) end, desc = "Buffer Diagnostics (Trouble)" },
  ...
  -- Todo comments
  {
    ...
    keys = {
      ...
      -- Trouble v3 integration
      { "<leader>xt", function() require("trouble").toggle("todo") end,  desc = "Todo (Trouble)" },
      { "<leader>xT", function() require("trouble").toggle("todo") end,  desc = "Todo/Fix/Fixme (Trouble)" },
